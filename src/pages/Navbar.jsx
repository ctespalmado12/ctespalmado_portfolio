          ...
          <div className="flex items-center justify-between py-[.85rem]">
            ...
            <nav aria-label="Primary">
              <ul className="hidden sm:flex gap-[1.2rem] list-none m-0 p-0">
                <li><a href="" className="text-[var(--text)] opacity-[.85] font-semibold hover:opacity-100 transition-opacity">Projects</a></li>
                <li><a href=""   className="text-[var(--text)] opacity-[.85] font-semibold hover:opacity-100 transition-opacity">Skills</a></li>
                <li><a href=""    className="text-[var(--text)] opacity-[.85] font-semibold hover:opacity-100 transition-opacity">About</a></li>
                <li><a href=""  className="text-[var(--text)] opacity-[.85] font-semibold hover:opacity-100 transition-opacity">Contact</a></li>
              </ul>
            </nav>
            ...
            <div className="flex items-center gap-[.5rem]">
              <button id="themeToggle" onClick={() => setIsLight(v => !v)}
                ...
                <svg  id="moon" className="w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true" style={{ display: 'none' }}
                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-moon-icon lucide-moon">
